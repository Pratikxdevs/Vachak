...
## Phase 12 — PDF worksheets (12-01, authored G1/G3 + smallest-PDF pool, 2026-09-16)

| Artifact | Source | License | Notes |
|----------|--------|---------|-------|
| Grade 1 `finding-furry-cat` (10q/30c/8p) | user-supplied authored bundle (`1/finding-furry-cat`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `2c13f7950f3ee3e7…`. |
| Grade 1 `how-many-times` (10q/30c/8p) | user-supplied authored bundle (`1/how-many-times`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `c5d7e373c473b383…`. |
| Grade 1 `santali-hindi-primer` (10q/30c/8p) | user-supplied authored bundle (`1/santali-hindi-primer`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `afec23a381ccf70e…`. |
| Grade 1 `so-many-toys` (10q/30c/4p) | user-supplied authored bundle (`1/so-many-toys`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `c89057b4c244523a…`. |
| Grade 1 `spend-my-day` (10q/30c/8p) | user-supplied authored bundle (`1/spend-my-day`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `382ad97dfa0db1b5…`. |
| Grade 3 `celebrating-festivals` (10q/30c/8p) | user-supplied authored bundle (`3/celebrating-festivals`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `02e4b00fb110c9d8…`. |
| Grade 3 `double-century` (10q/30c/8p) | user-supplied authored bundle (`3/double-century`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `3054647a69a923a1…`. |
| Grade 3 `fair-share` (10q/30c/0p) | user-supplied authored bundle (`3/fair-share`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `c392abde9b6c9ff1…`. |
| Grade 3 `family-and-friends` (10q/30c/0p) | user-supplied authored bundle (`3/family-and-friends`) | supplier content, **DRAFT — NOT APPROVED** | Converted verbatim by `scripts/convert_authored_chapters.py`; chapter sha256 `b59f5bf0c301dd9d…`. |
| `Class_4__Ticking_Clocks_and_Turning_Calendar__Santhali_.pdf` (3.2 MB, 9p, sha256 `3d3cb7284e7b0cc7…`) | textbook-derived Santali PDF (`santali_organized/Class-4/Mathematics/Class_4__Ticking_Clocks_and_Turning_Calendar__Santhali_.pdf`) | CC BY 4.0 (textbook-derived, AUTO_EXTRACTED) | Pool-shared worksheet source for Phase 12 pool slots (see `pdf_slot_mapping.json`); full sha256 in mapping + pack manifest. |
| `Class_1__Chapter_13_So_Many_Toys__Data_Handling___Santhali_.pdf` (3.2 MB, 2p, sha256 `73cff358eb1f3be4…`) | textbook-derived Santali PDF (`santali_organized/Class-1/Mathematics/Class_1__Chapter_13_So_Many_Toys__Data_Handling___Santhali_.pdf`) | CC BY 4.0 (textbook-derived, AUTO_EXTRACTED) | Pool-shared worksheet source for Phase 12 pool slots (see `pdf_slot_mapping.json`); full sha256 in mapping + pack manifest. |
| `Class_2__Playing_with_Lines__Santhali_.pdf` (3.3 MB, 6p, sha256 `d737369e1a9ae1d3…`) | textbook-derived Santali PDF (`santali_organized/Class-2/Mathematics/Class_2__Playing_with_Lines__Santhali_.pdf`) | CC BY 4.0 (textbook-derived, AUTO_EXTRACTED) | Pool-shared worksheet source for Phase 12 pool slots (see `pdf_slot_mapping.json`); full sha256 in mapping + pack manifest. |
| `Class_4__Elephants_Tigers__and_Leopards__Santhali_.pdf` (4.0 MB, 15p, sha256 `8b837f886d8088a4…`) | textbook-derived Santali PDF (`santali_organized/Class-4/Mathematics/Class_4__Elephants_Tigers__and_Leopards__Santhali_.pdf`) | CC BY 4.0 (textbook-derived, AUTO_EXTRACTED) | Pool-shared worksheet source for Phase 12 pool slots (see `pdf_slot_mapping.json`); full sha256 in mapping + pack manifest. |
| `Class_1__Chapter_11_How_Many_Times___Multiplication___Santhali_.pdf` (5.0 MB, 4p, sha256 `127cf2cdbe32877c…`) | textbook-derived Santali PDF (`santali_organized/Class-1/Mathematics/Class_1__Chapter_11_How_Many_Times___Multiplication___Santhali_.pdf`) | CC BY 4.0 (textbook-derived, AUTO_EXTRACTED) | Pool-shared worksheet source for Phase 12 pool slots (see `pdf_slot_mapping.json`); full sha256 in mapping + pack manifest. |
